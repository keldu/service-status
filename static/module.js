var modules = {
	...
	modulehost:function(info){
		...
		this.node.appendChild(modules.node("td","",new Date(info.time*1000).toLocaleString()));
		this.node.appendChild(modules.node("td","",new Date(info.changed*1000).toLocaleString()));
